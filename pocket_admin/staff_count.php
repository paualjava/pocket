...
class staff_count extends base
{
	...
	function __construct()
	{
		...
		$GLOBALS['smarty']->assign('title',"业绩统计");
	...
	function main()
	{
		...
		$GLOBALS['smarty']->display('staff_count.htm');
	}
...
$staff_count = new staff_count();
$sign=@is_callable(array($staff_count,$act));
if($sign)
$staff_count->$act();
else
