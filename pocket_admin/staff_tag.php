...
class staff_tag extends base
{
	private $page_size = 20; //一页显示的行数
	private $table_name="pocket_staff_tag";
	function __construct()
	{
		$GLOBALS['smarty']->assign('nav_left',"staff_tag");
	...
	function main()
	{
		...
		$GLOBALS['smarty']->display('staff_tag.htm');
	}
	/**
	 * 添加分组
	 *
	...
	function add()
	{
		$GLOBALS['smarty']->display('staff_tag_add.htm');
	}
	function ajax_add()
	{
	...
	function edit()
	{
		...
		$GLOBALS['smarty']->display('staff_tag_edit.htm');
	}
	/**
	 * 删除分类
	 *
...
$staff_tag = new staff_tag();
$sign=@is_callable(array($staff_tag,$act));
if($sign)
$staff_tag->$act();
else
